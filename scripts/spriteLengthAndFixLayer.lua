...
-- hook into the vram register writes to allow us to optionally turn off
-- sprites or the fix layer if needed. We get the actual video ram data
-- down below by grabbing it directly from video ram
